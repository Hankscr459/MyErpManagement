...
namespace MyErpManagement.Core.Modules.SupplierModule.IRepositories
{
    public interface ISupplierRepository : IRepository<Supplier>
    {
        ...
        IQueryable<Supplier> GetSearchQuery(SupplierListQueryModel queryModel);

        /// <summary>
        /// 更新供應商的標籤關聯 (比對差異並執行增刪)
        /// </summary>
        /// <param name="supplierId">供應商主鍵 ID</param>
        ...
        /// 2. 新增不在舊關聯中的新標籤
        /// </remarks>
        Task UpdateSupplierTags(Guid supplierId, List<Guid>? newTagIds);
    }
}
